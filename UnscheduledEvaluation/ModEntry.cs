    ...
    public class ModEntry : Mod
    {
        ...
        private void PatchDataEventsFarmHouse(AssetRequestedEventArgs e)
        {
            e.Edit(asset =>
            {
                ...
                const string newEvaluation2Key =
                    "558292/e 321777/t 600 620/HostMail " + AddEvaluationMailPatch.Evaluation1Mail + "/H";
                const string newEvaluation2KeyVanilla =
                    "558292/e 321777/t 600 620/!HostMail " + AddEvaluationMailPatch.Evaluation2Mail + "/H";
        ...
        private void RenameKey<TKey, TValue>(IDictionary<TKey, TValue> data, TKey oldKey, params TKey[] newKeys)
        {
            ...
            {
                var m =
                    "Skipping rename \"" + oldKey + "\" (missing=" + oldKeyMissing + ") to \"" + newKeys +
                    "\" (exists=" + newKeyExists + ")";
